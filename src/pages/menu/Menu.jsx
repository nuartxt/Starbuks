            ...
            <section className="main flex justify-between gap-10">
                ...
                <div className="right__side p-5 flex flex-col gap-10">
                    <p className='text-2xl font-bold'>
                        Восхитительные, приготовленные вручную напитки и вкусные блюда из тщательно отобранных ингредиентов высокого качества
                        <p className='text-2xl font-bold mt-5'>
                            Всё, что мы делаем, мы делаем с любовью к кофе и делимся ей с вами в Starbucks, где бы вы ни находились
                        </p>
                    </p>
                        ...
                        <div className='flex flex-wrap gap-3 '>
                            ...
                            {menu.map((obj) => (
                                <div className="shadow-lg p-5 rounded-lg">
                                    ...
                                    <NavLink to={obj.link}>
                                        <button onClick={() => setCategoryPage(obj.id)} className="text-sm font-bold border border-green-500 rounded-full py-2 px-5 hover:bg-green-200 text-green-800 transition ease-in duration-300 my-10">Узнать больше</button>
                                    </NavLink>
                                </div>
                            ))}
